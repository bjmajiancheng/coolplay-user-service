...
public class CompamyController {
    ...
    public Result companyDetail(@RequestParam("id") Integer id) {
        ...
        try {
            ...
            List<Integer> companyIds = userCollectService
                    .findCompanyIdsByUserIdAndCompanyIds(SecurityUtil.getCurrentUserId(),
    ...
    public Result collectCompany(@RequestParam("id") Integer id, @RequestParam("type") Integer type) {
        ...
        try {
            ...
            return ResponseUtil.success(Collections
                    .singletonMap("collectCnt", userCollectService.findCntByCollectTypeAndCollectTypeId(3, id)));
