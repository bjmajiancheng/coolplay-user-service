package com.coolplay.user.security.constants;
...
public class SecurityConstant {
    ...
    public static final String USER_CACHE_PREFIX = "coolplay_user_service_user_";

    public static final String RESOURCE_MAP = "coolplay_user_service_resouce_map";

    public static final String FUNCTION_CACHE_PREFIX = "coolplay_user_service_function_";
    ...
    public static final String WEATHER_CITY_DATA_KEY = "coolplay_user_service_city_%s";
